...
ruleSections:
  ...
  - title: Человек (Дангун)
    text: |-
      ...
      Золотой язык оазиса: Базары Дангуна обострили ваш ум для переговоров. Вы можете с абсолютной точностью определить стоимость немагического предмета стоимостью до 100 зм по его внешнему виду, и добавляете удвоенный бонус мастерства к проверкам Интеллекта (Анализ), когда определяете цену немагических предметов.
  - title: Человек (Бралл)
    text: |-
  ...
  - title: Человек (Адаад)
    text: |-
      ...
      Воля Культуры: Вы можете добавить 1к4 к проверкам Анализа, Выживания и Ухода за Животными.
