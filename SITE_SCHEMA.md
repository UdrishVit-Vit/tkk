...
- блок «Свод "Огни"» в карточке: главы со ссылками в `/lore/uzly/ogni?chapter=…`,
  атрибуты по виду статьи, связи с другими статьями и строку о главах, где имя
  звучит в книге, но сведений ещё не записано;
