...
(82 статьи) и собирает из него и «Огней» единый `LORE_GLOSSARY` — 437 статей.
Совпадение ищется по названию и синонимам: 13 статей известны обоим источникам
и показывают два свидетельства в одной карточке, у остальных источник один.
