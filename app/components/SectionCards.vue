    ...
    <div class="cards-wrap">
      ...
      <div class="cards-grid">
        <div v-for="(c, i) in vm.sectionCards" :key="i" class="card-tile">
          ...
          <svg viewBox="0 0 40 40" class="card-corner" fill="none" stroke="rgba(var(--theme-accent-rgb),.4)" stroke-width="1"><path d="M3 22 L3 3 L22 3"/></svg>
          <div class="card-body">
            <div>
...
.cards-eyebrow{font-family:'Hanken Grotesk',sans-serif;font-size:11px;letter-spacing:.34em;text-transform:uppercase;color:rgba(var(--theme-text-rgb),.42)}
.cards-title{font-family:'Cormorant Garamond',serif;font-size:48px;letter-spacing:.01em;color:rgba(var(--theme-heading-rgb),.96);margin-top:8px;line-height:1.04}
.cards-back{flex:none;margin-top:8px;font-family:'Hanken Grotesk',sans-serif;font-size:10px;letter-spacing:.22em;text-transform:uppercase;color:rgba(var(--theme-text-rgb),.55);border:1px solid rgba(var(--theme-contrast-rgb),.16);border-radius:22px;padding:9px 16px;cursor:pointer}
.cards-back:hover{background:rgba(var(--theme-contrast-rgb),.05)}
.cards-toolbar{display:flex;gap:12px;margin:30px 0}
.cards-search{flex:1;padding:14px 18px;background:rgba(var(--theme-contrast-rgb),.04);border:1px solid rgba(var(--theme-contrast-rgb),.1);border-radius:13px;outline:none;color:rgba(var(--theme-heading-rgb),.95);font-family:'Cormorant Garamond',serif;font-size:18px}
...
.card-diamond{position:absolute;top:14px;right:16px;width:62px;height:62px;transform:rotate(45deg);border:1px solid rgba(var(--theme-accent-rgb),.34);border-radius:6px}
...
.card-sub{font-family:'Hanken Grotesk',sans-serif;font-size:11px;letter-spacing:.14em;color:rgba(var(--theme-accent-rgb),.85);margin-top:3px}
.card-badges{display:flex;align-items:center;gap:7px;flex-wrap:wrap}
.card-badge{font-family:'Hanken Grotesk',sans-serif;font-size:10.5px;letter-spacing:.03em;color:rgba(var(--theme-accent-strong-rgb),.96);background:rgba(40,32,16,.72);border:1px solid rgba(var(--theme-accent-rgb),.3);border-radius:999px;padding:4px 11px;white-space:nowrap}
.card-tag{font-family:'Hanken Grotesk',sans-serif;font-size:9.5px;font-weight:600;letter-spacing:.12em;color:rgba(20,15,6,.95);background:rgba(var(--theme-accent-rgb),.9);border-radius:7px;padding:4px 8px}
</style>
