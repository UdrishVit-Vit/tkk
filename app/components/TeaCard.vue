...
.tea-pill{ display:inline-flex; align-items:baseline; gap:8px; border:1px solid rgba(214,170,96,.32); border-radius:999px; background:rgba(214,170,96,.08); padding:5px 13px; }
.tea-pill span{ font-size:9px; font-weight:800; letter-spacing:.16em; text-transform:uppercase; color:rgba(214,170,96,.7); }
.tea-pill b{ font-size:13px; font-weight:700; color:rgba(244,224,170,.9); }
.tea-tag{ border:1px solid rgba(232,236,248,.12); border-radius:999px; padding:4px 10px; font-size:10px; font-weight:700; color:rgba(232,236,248,.55); }
.tea-combo{ border-color:rgba(214,170,96,.28); color:rgba(214,170,96,.8); }

.tea-flavor{ margin:0 0 16px; font-family:'Cormorant Garamond',serif; font-style:italic; font-size:19px; line-height:1.55; color:rgba(214,170,96,.78); white-space:pre-line; }

.tea-block{ margin-top:14px; padding:12px 16px; border:1px solid rgba(232,236,248,.09); border-left-width:2px; border-radius:8px; background:rgba(255,255,255,.012); }
.tea-block h3{ margin:0 0 6px; font-size:10px; font-weight:850; letter-spacing:.18em; text-transform:uppercase; color:rgba(232,236,248,.5); }
.tea-block p{ margin:0; font-family:'Cormorant Garamond',serif; font-size:18px; line-height:1.55; color:rgba(224,232,242,.84); white-space:pre-line; }
.tea-effect{ border-left-color:rgba(214,170,96,.55); }
.tea-effect h3{ color:rgba(214,170,96,.8); }
...
.tea-table{ margin-top:14px; padding:12px 16px; border:1px solid rgba(214,170,96,.18); border-radius:8px; background:rgba(214,170,96,.04); overflow-x:auto; }
.tea-table-label{ margin-bottom:10px; font-size:11px; font-weight:800; letter-spacing:.14em; text-transform:uppercase; color:rgba(214,170,96,.75); }
.tea-table-grid{ display:grid; grid-template-columns:minmax(56px,auto) repeat(calc(var(--cols) - 1),minmax(0,1fr)); gap:1px; background:rgba(232,236,248,.07); border-radius:6px; overflow:hidden; }
.tea-th{ padding:8px 12px; background:rgba(20,22,30,.96); font-size:10px; font-weight:800; letter-spacing:.12em; text-transform:uppercase; color:rgba(214,170,96,.75); }
.tea-td{ padding:9px 12px; background:rgba(14,16,23,.96); font-size:13.5px; line-height:1.5; color:rgba(224,232,242,.78); }
.tea-td.first{ font-weight:800; color:rgba(214,170,96,.75); font-variant-numeric:tabular-nums; }
</style>
