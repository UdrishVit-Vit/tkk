...
.history-node--era.has-emblem.is-rebirth{width:104px;height:104px}.history-node--era.has-emblem.is-rebirth img{width:100px;height:100px}
.history-node--era.has-emblem.is-light{width:108px;height:108px}.history-node--era.has-emblem.is-light img{width:104px;height:104px}
.history-node--era.has-emblem.is-human{width:112px;height:112px}.history-node--era.has-emblem.is-human img{width:108px;height:108px}
.history-node--era.has-emblem.is-restore{width:116px;height:116px}.history-node--era.has-emblem.is-restore img{width:112px;height:112px}
.history-node--era.has-emblem.is-winds{width:108px;height:108px}.history-node--era.has-emblem.is-winds img{width:104px;height:104px}
...
@media(max-width:720px){.lore-viewport{top:0}.lore-history__texture{inset:0}.history-intro__sigil{width:72px;height:72px}.history-intro__sigil::after{inset:1px}.history-intro__sigil img{width:68px;height:68px}.history-node--era.has-emblem{width:62px;height:62px}.history-node--era.has-emblem img{width:60px;height:60px}.history-node--era.has-emblem.is-rebirth{width:68px;height:68px}.history-node--era.has-emblem.is-rebirth img{width:66px;height:66px}.history-node--era.has-emblem.is-light{width:70px;height:70px}.history-node--era.has-emblem.is-light img{width:68px;height:68px}.history-node--era.has-emblem.is-human{width:72px;height:72px}.history-node--era.has-emblem.is-human img{width:70px;height:70px}.history-node--era.has-emblem.is-restore{width:74px;height:74px}.history-node--era.has-emblem.is-restore img{width:72px;height:72px}.history-node--era.has-emblem.is-winds{width:70px;height:70px}.history-node--era.has-emblem.is-winds img{width:68px;height:68px}}
