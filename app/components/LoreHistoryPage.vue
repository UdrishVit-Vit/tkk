...
<style scoped>
.lore-history{position:absolute;inset:0 0 0 68px;z-index:58;overflow:auto hidden;color:rgba(var(--theme-text-rgb),.9);isolation:isolate}
...
.history-map::before{content:'';position:absolute;inset:0 5px 50px;border:1px solid rgba(var(--theme-accent-rgb),.1);background:repeating-linear-gradient(45deg,transparent 0 13px,rgba(var(--theme-accent-rgb),.012) 13px 14px),linear-gradient(90deg,transparent,rgba(var(--theme-accent-rgb),.018) 48%,rgba(var(--theme-accent-rgb),.035) 50%,rgba(var(--theme-accent-rgb),.018) 52%,transparent);mask-image:linear-gradient(transparent,#000 4%,#000 94%,transparent)}
...
.history-era{position:relative;z-index:2;display:grid;min-height:164px;grid-template-columns:minmax(0,1fr) 64px minmax(0,1fr);align-items:center}.history-era__card{position:relative;display:flex;min-height:154px;flex-direction:column;justify-content:center;border:1px solid rgba(var(--theme-accent-rgb),.25);background:radial-gradient(circle at 20% 50%,rgba(var(--theme-accent-rgb),.05),transparent 48%),repeating-linear-gradient(90deg,rgba(var(--theme-contrast-rgb),.012) 0 1px,transparent 1px 5px),rgb(var(--theme-surface-rgb));padding:22px 29px;text-decoration:none;color:inherit;box-shadow:0 15px 38px rgba(0,0,0,.17),0 0 0 5px rgba(var(--theme-surface-rgb),.28);transition:transform .25s ease,border-color .25s ease,box-shadow .25s ease}.history-era--left .history-era__card{grid-column:1}.history-era--right .history-era__card{grid-column:3}.history-era__card::before{content:'';position:absolute;inset:7px;border:1px dashed rgba(var(--theme-accent-rgb),.12)}.history-era__card:hover,.history-era__card:focus-visible{transform:translateY(-3px);border-color:rgba(var(--theme-accent-rgb),.52);box-shadow:0 18px 46px rgba(0,0,0,.2),0 0 25px rgba(var(--theme-accent-rgb),.08);outline:none}
