...
.omen-pill{ display:inline-flex; align-items:baseline; gap:8px; border:1px solid rgba(var(--theme-accent-rgb),.32); border-radius:999px; background:rgba(var(--theme-accent-rgb),.08); padding:5px 13px; }
.omen-pill span{ font-size:9px; font-weight:800; letter-spacing:.16em; text-transform:uppercase; color:rgba(var(--theme-accent-rgb),.7); }
.omen-pill b{ font-size:13px; font-weight:700; color:rgba(var(--theme-accent-strong-rgb),.9); }
.omen-tag{ border:1px solid rgba(var(--theme-text-rgb),.12); border-radius:999px; padding:4px 10px; font-size:10px; font-weight:700; color:rgba(var(--theme-text-rgb),.55); }
.omen-combo{ border-color:rgba(var(--theme-accent-rgb),.28); color:rgba(var(--theme-accent-rgb),.8); }

.omen-flavor{ margin:0 0 16px; font-family:'Cormorant Garamond',serif; font-style:italic; font-size:19px; line-height:1.55; color:rgba(var(--theme-accent-rgb),.78); }

.omen-block{ margin-top:14px; padding:12px 16px; border:1px solid rgba(var(--theme-text-rgb),.09); border-left-width:2px; border-radius:8px; background:rgba(var(--theme-contrast-rgb),.012); }
.omen-block h3{ margin:0 0 6px; font-size:10px; font-weight:850; letter-spacing:.18em; text-transform:uppercase; color:rgba(var(--theme-text-rgb),.5); }
.omen-block p{ margin:0; font-family:'Cormorant Garamond',serif; font-size:18px; line-height:1.55; color:rgba(var(--theme-text-rgb),.84); }
.omen-effect{ border-left-color:rgba(var(--theme-accent-rgb),.55); }
.omen-effect h3{ color:rgba(var(--theme-accent-rgb),.8); }
...
.omen-table{ margin-top:14px; padding:12px 16px; border:1px solid rgba(var(--theme-accent-rgb),.18); border-radius:8px; background:rgba(var(--theme-accent-rgb),.04); }
.omen-table-label{ margin-bottom:8px; font-size:11px; font-weight:800; letter-spacing:.14em; text-transform:uppercase; color:rgba(var(--theme-accent-rgb),.75); }
.omen-table ol{ display:flex; flex-direction:column; gap:7px; margin:0; padding:0; list-style:none; }
.omen-table li{ display:flex; gap:12px; font-size:14px; line-height:1.5; color:rgba(var(--theme-text-rgb),.78); }
.omen-roll-num{ flex:0 0 auto; width:20px; font-weight:800; color:rgba(var(--theme-accent-rgb),.7); font-variant-numeric:tabular-nums; }
</style>
