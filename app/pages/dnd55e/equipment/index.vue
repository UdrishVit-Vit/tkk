...
import { equipmentIconName } from '~/data/dnd55e/equipment-icons.js'
  ...
  >
    ...
    <template #item="{ item }">
      <span class="equipment-list-card">
        <span class="equipment-glyph" :class="`kind-${item.raw.kind}`" aria-hidden="true">
          <UIcon :name="equipmentIconName(item.raw.id)" class="equipment-item-icon" />
        </span>
    ...
    <template #body="{ item }">
      ...
      <header class="equipment-card-heading">
        <span class="equipment-card-icon" :class="`kind-${item.raw.kind}`" aria-hidden="true">
          <UIcon :name="equipmentIconName(item.raw.id)" class="equipment-item-icon" />
        </span>
        <span>
...
.equipment-list-card{display:flex;align-items:center;gap:10px;width:100%;min-width:0}.equipment-glyph,.equipment-card-icon{display:grid;place-items:center;border:1px solid rgba(var(--theme-accent-rgb),.2);border-radius:8px;background:rgba(var(--theme-accent-rgb),.06);color:var(--theme-accent-strong)}.equipment-glyph{width:35px;height:35px;flex:0 0 auto;font-size:16px}.equipment-glyph .equipment-item-icon{width:21px;height:21px}.equipment-list-copy{display:flex;flex-direction:column;min-width:0}.equipment-list-name{font-weight:750;white-space:nowrap;overflow:hidden;text-overflow:ellipsis}
.equipment-card-heading{display:grid;grid-template-columns:auto 1fr;gap:16px;align-items:center;margin:14px 0 18px}.equipment-card-icon{width:66px;height:66px;font-size:27px}.equipment-card-icon .equipment-item-icon{width:40px;height:40px}.equipment-card-title,.equipment-card-original,.equipment-card-summary{display:block}.equipment-card-title{font:700 25px/1.15 Georgia,serif;color:var(--theme-heading)}.equipment-card-original{margin-top:2px;color:rgba(var(--theme-accent-rgb),.7);font-size:13px}.equipment-card-summary{max-width:720px;margin-top:8px;color:rgba(var(--theme-text-rgb),.72);line-height:1.52}
...
@media (max-width:760px){.rules-grid{grid-template-columns:1fr}.rules-panel.wide{grid-column:auto}.glossary-grid,.mastery-grid,.pack-list,.crafting-layout{grid-template-columns:1fr}.coin-line{grid-template-columns:repeat(2,1fr)}.equipment-stats{grid-template-columns:repeat(2,minmax(0,1fr))}.equipment-card-heading{grid-template-columns:1fr}.equipment-card-icon{width:50px;height:50px}.armor-details dl,.vehicle-details dl{grid-template-columns:1fr}}
</style>
