...
// по маршруту. Список фиксирован — файлов пятнадцать.
export const RACE_DOSSIERS = [
  ...
  { title: 'Кобольд', slug: 'koboldy', summary: 'Мелкий народ дюн и кяризов, порождённый Иджин’Аном, плетущий ловушки и молящийся звезде-трюкачу Джу’джу’вару.' },
