...
export const SYSTEMS = [
  ...
  { id:'2024', name:'D&D 5.5e',   tag:'2024', groups:[
      { name:'Персонаж',    sections:['Классы','Виды','Черты','Особенности классов','Предыстории','Заклинания'] },
...
export const POOL = {
  ...
  eras:['Жертва Пуруша','Эпоха Рассвета','Эпоха Перерождения','Эпоха Света','Эпоха Людей','Эпоха Восстановления','Время Ветров'],
