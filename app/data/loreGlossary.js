...
export const LORE_GLOSSARY_ARCHIVE = [
  ...
  {
    id: 'mel-ozar', term: 'Мел Озар', category: 'characters', aliases: ['Король Королей'],
    definition: 'Величайший человеческий король, основатель Братства Золотого Симурга и Империи Ургон. Его одержимость Дальними Чертогами привела к Очищению и Великому Раздору. К нему восходит кровь Мел, которой гордится людской род.',
    related: ['vremena-koroley', 'obman', 'ochishchenie', 'mel'], history: 'epoha-lyudey',
  },
  {
  ...
  // ——— Мафраш и Синдикат ———
  {
    id: 'emefeyus', term: 'Эмефеюс Урегал Мафраш', category: 'characters', aliases: ['Эмефеюс'],
    definition: 'Величайший из живших магусов и основатель ордена Мафраш, призванного соблюдать нейтралитет и хранить Великое Равновесие Даскара. Ему Гендин даровал камни стазиса, что несут главы медресе.',
    related: ['gendin'],
  },
  {
  ...
  // ——— Спирали ———
  {
    id: 'edra', term: 'Эдр’а', category: 'characters', aliases: [],
    definition: 'Синтетический мор’хор, созданный величайшими умами Спирали как эксперимент. Вырвала Спираль из цикла м’хур и создала детей по своему образу — мор’хоров, свободных от воли создателей.',
    related: ['morhory'],
  },
  {
  ...
  {
    id: 'pyur', term: 'Пйюр', category: 'characters', aliases: ['Безумец Пйюр'],
    definition: 'Первый Белый Пророк: он обладал такой силой воли и так верил в собственные слова, что они становились правдой. Прежде чем его поймали Улунгуры, он раскрыл нескольким удришам истины мироздания и исчез в маленькой коробке с лабиринтом внутри.',
    related: ['belyy-prorok'], history: 'epoha-sveta',
  },
